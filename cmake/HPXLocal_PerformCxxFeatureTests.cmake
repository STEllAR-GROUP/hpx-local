...
function(hpx_local_perform_cxx_feature_tests)
  hpx_local_check_for_cxx11_std_atomic(
    REQUIRED "HPXLocal needs support for C++11 std::atomic"
  )
  ...
  hpx_local_check_for_cxx17_memory_resource(
    DEFINITIONS HPX_HAVE_CXX17_MEMORY_RESOURCE
  )

  # C++20 feature tests
  if(HPXLocal_CXX_STANDARD GREATER_EQUAL 20)
  ...
  hpx_local_check_for_cxx_lambda_capture_decltype(
