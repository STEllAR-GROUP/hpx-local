...
if(HPXLocal_WITH_CUDA AND NOT TARGET Cuda::cuda)
  ...
  if(DEFINED CMAKE_CUDA_STANDARD AND NOT CMAKE_CUDA_STANDARD STREQUAL
    ...
    hpx_local_error(
      "You've set CMAKE_CUDA_STANDARD to ${CMAKE_CUDA_STANDARD} and HPXLocal_CXX_STANDARD to ${HPXLocal_CXX_STANDARD}. Please unset CMAKE_CUDA_STANDARD."
    )
  endif()

  set(CMAKE_CUDA_STANDARD ${HPXLocal_CXX_STANDARD})
