...
if(NOT TARGET hpx_local_dependencies_boost)
  ...
  add_library(hpx_local_dependencies_boost INTERFACE IMPORTED)

  target_link_libraries(hpx_local_dependencies_boost INTERFACE Boost::boost)
  foreach(__boost_library ${__boost_libraries})
    target_link_libraries(
      hpx_local_dependencies_boost INTERFACE Boost::${__boost_library}
    )
  endforeach()

  if(HPXLocal_WITH_HIP AND Boost_VERSION VERSION_LESS 1.78)
    target_compile_definitions(
      hpx_local_dependencies_boost
  ...
  if(NOT Boost_USE_STATIC_LIBS)
    hpx_local_add_config_cond_define(BOOST_ALL_DYN_LINK)
  endif()
  hpx_local_add_config_cond_define(BOOST_BIGINT_HAS_NATIVE_INT64)
  target_link_libraries(
    hpx_local_dependencies_boost INTERFACE Boost::disable_autolinking
  )

  if(NOT MSVC)
    hpx_local_add_config_define(HPX_LOCAL_COROUTINE_NO_SEPARATE_CALL_SITES)
  endif()
endif()
