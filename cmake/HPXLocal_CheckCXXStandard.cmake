...
if(HPXLocal_CXX_STANDARD LESS 17)
  hpx_local_error(
    "You've set HPXLocal_CXX_STANDARD to ${HPXLocal_CXX_STANDARD}, which is less than 17 which is the minimum required by HPXLocal"
  )
endif()
...
if(DEFINED CMAKE_CXX_STANDARD AND NOT CMAKE_CXX_STANDARD STREQUAL
  ...
  hpx_local_error(
    "You've set CMAKE_CXX_STANDARD to ${CMAKE_CXX_STANDARD} and HPXLocal_CXX_STANDARD to ${HPXLocal_CXX_STANDARD}. Please unset CMAKE_CXX_STANDARD."
  )
endif()

set(CMAKE_CXX_STANDARD ${HPXLocal_CXX_STANDARD})
