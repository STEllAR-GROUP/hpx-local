...
namespace hpx { namespace parallel { namespace execution {
    ...
    using parallel_policy HPX_LOCAL_DEPRECATED_V(1, 6,
    ...
    template <typename Executor, typename Parameters>
    using parallel_policy_shim HPX_LOCAL_DEPRECATED_V(1, 6,
    ...
    using parallel_task_policy HPX_LOCAL_DEPRECATED_V(1, 6,
    ...
    template <typename Executor, typename Parameters>
    using parallel_task_policy_shim HPX_LOCAL_DEPRECATED_V(1, 6,
    ...
    using parallel_unsequenced_policy HPX_LOCAL_DEPRECATED_V(1, 6,
    ...
    using sequenced_task_policy HPX_LOCAL_DEPRECATED_V(1, 6,
    ...
    template <typename Executor, typename Parameters>
    using sequenced_task_policy_shim HPX_LOCAL_DEPRECATED_V(1, 6,
