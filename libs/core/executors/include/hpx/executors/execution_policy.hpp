...
namespace hpx { namespace parallel { namespace execution {
    ...
    template <typename Executor, typename Parameters>
    using parallel_policy_shim HPX_LOCAL_DEPRECATED_V(0, 1,
    ...
    using parallel_task_policy HPX_LOCAL_DEPRECATED_V(0, 1,
    ...
    template <typename Executor, typename Parameters>
    using parallel_task_policy_shim HPX_LOCAL_DEPRECATED_V(0, 1,
    ...
    using parallel_unsequenced_policy HPX_LOCAL_DEPRECATED_V(0, 1,
    ...
    using sequenced_executor HPX_LOCAL_DEPRECATED_V(0, 1,
    ...
    using sequenced_task_policy HPX_LOCAL_DEPRECATED_V(0, 1,
    ...
    template <typename Executor, typename Parameters>
    using sequenced_task_policy_shim HPX_LOCAL_DEPRECATED_V(0, 1,
