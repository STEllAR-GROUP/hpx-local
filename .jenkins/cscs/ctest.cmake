...
if(NOT processor_count EQUAL 0)
  ...
  set(max_test_parallelism 10)
  if(processor_count LESS max_test_parallelism)
    set(test_args PARALLEL_LEVEL ${processor_count})
  else()
    set(test_args PARALLEL_LEVEL ${max_test_parallelism})
  endif()
endif()
...
set(CTEST_CONFIGURE_COMMAND
    "${CTEST_CONFIGURE_COMMAND} -DHPXLocal_WITH_PARALLEL_TESTS_BIND_NONE=ON"
)
set(CTEST_CONFIGURE_COMMAND
